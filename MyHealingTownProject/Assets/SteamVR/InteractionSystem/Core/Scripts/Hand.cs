...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        //摇杆移动
        public SteamVR_Action_Vector2 moveAction = SteamVR_Input.GetAction<SteamVR_Action_Vector2>("TouchPad");
        //摇杆旋转
        public SteamVR_Action_Boolean rotationAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("SnapTurnRight");
        //背包键
        public SteamVR_Action_Boolean inventoryAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("OpenInventory");
        ////互动键
        //public SteamVR_Action_Boolean interactableAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("InteractTool");
        ...
        {
            ControllerButtonHints.ShowButtonHint(this, grabPinchAction);//Trigger键提示显示
        }

        public void HideTriggerHint()
        {
            ControllerButtonHints.HideButtonHint(this, grabPinchAction);//Trigger键提示隐藏
        }

        //TODO：移动键显示
        public void ShowMoveHint()
        {
            ControllerButtonHints.ShowButtonHint(this,moveAction);//摇杆键提示显示
        }

        public void HideMoveHint()
        {
            ControllerButtonHints.HideButtonHint(this,moveAction);//摇杆键提示隐藏
        }

        //TODO:旋转键显示
        public void ShowRotationHint()
        {
            ControllerButtonHints.ShowButtonHint(this, rotationAction);//摇杆键提示显示
        }

        public void HideRotationHint()
        {
            ControllerButtonHints.HideButtonHint(this, rotationAction);//摇杆键提示隐藏
        }

        //TODO:开启背包
        public void ShowInventoryHint()
        {
            ControllerButtonHints.ShowButtonHint(this, inventoryAction);
        }
        public void HideInventoryHint()
        {
            ControllerButtonHints.HideButtonHint(this, inventoryAction);
        }

        ////TODO:交互键
        //public void ShowInteractHint()
        //{
        //    ControllerButtonHints.ShowButtonHint(this, interactableAction);
        //}
        //public void HideInteractHint()
        //{
        //    ControllerButtonHints.HideButtonHint(this, interactableAction);
        //}
